-- orden/70_universo.sql — RECONSTRUIR EL UNIVERSO DEL BACKTEST
-- (copia canonica de iss094b; se ejecuta DESPUES de 60_espera_bootstrap.sql)
--
...
-- Las assertions viven en orden/80_assertions.sql, no aqui.
