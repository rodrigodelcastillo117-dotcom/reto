...
| 2b | iss037_crossleague_phi_versioned_snapshot | iss027 (liga_fuerza) | `v2.liga_fuerza_version`, `v2.fn_crossleague_phi_asof` | replay φ as-of fail-closed | DROP tabla/función nuevas |
