-- ============================================================================
-- iss034b — ROLLBACK CAPTURE (prod current versions) · READ-ONLY provenance
-- ============================================================================
-- This is the rollback snapshot mandated by the DAG note ("Pasos 8-10 REEMPLAZAN
-- funciones de prod: capturar pg_get_functiondef ANTES"). The four functions below
-- were captured VERBATIM from prod (wpiztubmmmzclhlprgpd) via pg_get_functiondef()
-- and are the exact defs to restore if iss034b's install ever needs reverting.
-- Because iss034b installs the prod versions verbatim (branch-only, no prod mutation),
-- this capture is byte-identical to the staged file. NO PROD MUTATION.
-- ============================================================================
